...
println "HostName, Total-Items-Count, Folder-Count, Workflow-Job-Count, Maven-ModuleSet-Count, MultiBranch-Count, FreeStyle-Count, JobTemplate-Count, MavenModule-Count, Oragnization-Folder-Count, Matrix-Configuration-Count, Matrix-Project-Count, Folder-Template-Count, AuxModel-Count, IvyModuleSet-Count, BuilderTemplate-Count, PublisherTemplate-Count, UnKnown"
println "${java.net.InetAddress.getLocalHost()}, ${iItemCount}, ${iFolderCount}, ${iJobCount}, ${iMavenModuleSet}, ${iMultiBranchProject}, ${iFreeStyle}, ${iJobTemplate}, ${iMavenModule}, ${iOrgFolder}, ${iMatrixConf}, ${iMatrixProj}, ${iFolderTemp}, ${iAuxModel}, ${iIvyModuleSet}, ${iBuilderTemplate}, ${iPublisherTemplate}, ${iCount}"
println "========="

println "Host Name - ${java.net.InetAddress.getLocalHost()}"
