...
def folderName= "MDES" //"MCSendR"; //"MarketingBusinessSolutionsDevOps"; // change value `folder-a` for the full name of the folder you want to disable all jobs in
...
Map<String, String> schedules = j.getItemByFullName(folderName, AbstractFolder).getAllItems(Job).findAll { Job job ->
