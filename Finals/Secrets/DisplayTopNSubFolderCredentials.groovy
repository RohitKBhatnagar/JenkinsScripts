...
for (c in allCredentials) {
	...
	//paswdTemp = hudson.util.Secret.fromString('{AQAAABAAAABQh6ZZKCVb/6t6O56bYS9k6+7RECAGNxec169MZ7AaI/CQ7oZJFQky7gUCIzOzQzjFkpzOlg5f7O97DRQOVJqQv2iXGAl0wc9m0GPG9fWKcz9BPYPN2RUQgmdX3COZDlBK}').plainText
	//println('Password from Text -  ' + paswdTemp)
    }
