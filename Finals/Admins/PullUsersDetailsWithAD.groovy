///Extremely heavu script to pull all users and associated groups and their relationship with Mastercard AD
///https://github.com/cloudbees/jenkins-scripts/blob/master/rbacOnItems.groovy
